...
public class StudentBSTTest {
	...
	public void testSort() {
		Integer[] order = { -40, -34, 0, 2, 5, 6, 9, 12, 23, 67, 76, 232 };
		assertArrayEquals(order, tree.sort(order));
		Integer[] array = { 6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40 };
		assertArrayEquals(order, tree.sort(array));

		array = new Integer[] {};
		assertArrayEquals(array, tree.sort(array));
		assertNull(tree.sort(null));
		array = new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		assertArrayEquals(order, tree.sort(array));
	...
	public void testReverseOrder() {
		Integer[] reverse = new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		Integer[] order = { -40, -34, 0, 2, 5, 6, 9, 12, 23, 67, 76, 232 };
		fillTree();
		assertArrayEquals(reverse, tree.reverseOrder());
		tree.sort(order);
		assertArrayEquals(reverse, tree.reverseOrder());
		tree.sort(reverse);
		assertArrayEquals(reverse, tree.reverseOrder());
