 ...
 * essa heap deixa os elementos maiores no topo. Essa compara̤̣o ṇo
 * ̩ feita diretamente com os elementos armazenados, mas sim usando um
...
public class HeapImpl<T extends Comparable<T>> implements Heap<T> {
	...
	/**
	 * O comparador ̩ utilizado para fazer as compara̵̤es da heap. O
	 * ideal ̩ mudar apenas o comparator e mandar reordenar a heap usando
	 * esse comparator. Assim os metodos da heap ṇo precisam saber se vai
